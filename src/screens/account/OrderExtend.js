...
} else if (rentalEndDate && !isNaN(new Date(rentalEndDate).getTime())) {
  console.warn('Sử dụng rentalEndDate làm ngày bắt đầu vì rentalStartDateRaw không hợp lệ.');
  computedStartDate = new Date(rentalEndDate);
} else {
  console.warn('Không có rentalStartDateRaw hoặc rentalEndDate hợp lệ. Sử dụng ngày hiện tại.');
